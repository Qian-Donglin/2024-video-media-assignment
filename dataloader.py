...
def load_MNIST(batch_size : int, batch_size_val : int, noise_type : str, noise_rate : float, num_val : int): 
    ...
    val_idx = set(random.sample(range(len(train)), num_val))

    # remove val from train and prepare val dataset
    data_train = []
    data_val = []
